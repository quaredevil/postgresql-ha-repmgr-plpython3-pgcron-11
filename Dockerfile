...
RUN install_packages python3 postgresql-contrib postgresql-plpython3-11

##[Extension][plpython3] | copy
RUN mv /usr/share/postgresql/11/extension/*plpython3* /opt/bitnami/postgresql/share/extension/
RUN mv /usr/lib/postgresql/11/lib/*plpython3* /opt/bitnami/postgresql/lib/
...
##[Extension][pg_cron]
RUN install_packages postgresql-11-cron

##[Extension][pg_cron] | copy
RUN mv /usr/share/postgresql/11/extension/*pg_cron* /opt/bitnami/postgresql/share/extension/
RUN mv /usr/lib/postgresql/11/lib/*pg_cron* /opt/bitnami/postgresql/lib/
